...
var ttvCmd = &cobra.Command{
	Use:   "ttv",
	Short: "ttv command is mainly used to fetch chat logs of a vod",
	Long:  `ttv command uses TwitchDownloader CLI by lay295 on github to fetch chat logs and store it in json file in the given target directory`,
	Run:   rateIt,
}
